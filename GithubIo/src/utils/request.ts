 ...
 * A data数据请求
 */
export const requestA = new BaseRequest({
    baseURL: import.meta.env.VITE_API_A_URL,
    // 请求超时时间
    timeout: 10000,
})
/**
 * B data数据请求
 */
export const requestB = new BaseRequest({
    baseURL: import.meta.env.VITE_API_B_URL,
    // 请求超时时间
    timeout: 10000,
})
/**
